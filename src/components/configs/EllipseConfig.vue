...
const form = reactive<IEllipseConfig>({
  width: 200, // 宽度
  height: 200, // 高度
  fill: [], // 填充颜色
  startAngle: 0, // 开始角度
...
<template>
  <el-form :model="form" label-width="auto" style="max-width: 600px">
    ...
    <el-form-item class="fill-config">
      <template #label> Fill config </template>
      <el-button type="primary" @click="openFillConfig"
        >Open Fill Config</el-button
      >
      <div class="fill-config-editor" ref="fillConfigRef"></div>
      <el-button
        type="primary"
        @click="updateFill(JSON.parse(editor.getValue()))"
        >Update Fill</el-button
      >
    </el-form-item>
    ...
    <el-form-item label="End Angle">
      <el-input type="number" :min="-180" :max="180" v-model="form.endAngle" />
    </el-form-item>
